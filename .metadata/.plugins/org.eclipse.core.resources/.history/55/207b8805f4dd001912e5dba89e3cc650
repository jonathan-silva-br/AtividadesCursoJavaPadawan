			...
			while ((opcao > 0) || (opcao < 5)) {
				switch(opcao) {
					case 2:
						...
						System.out.println("Informe o valor desejado para o depósito: ");
					...
					case 4:
						System.out.println("4 - Saldo");
						System.out.println("Seu saldo disponível é de " + Saldo[0]);
						break;
					default:
				}
				System.out.println("MENU DE OPÇÕES: ");
			...
			if ((cpf == Cpf[1]) && (senha == Senha[1])) {
				...
				while ((opcao > 0) || (opcao < 4)) {
					switch(opcao) {
						...
						case 4:
							System.out.println("4 - Saldo");
							System.out.println("Seu saldo disponível é de " + Saldo[1]);
							break;
						default:
					}
				}
				...
				if ((cpf == Cpf[2]) && (senha == Senha[2])) {
					...
					while ((opcao > 0) || (opcao < 4)) {
						switch(opcao) {
							...
							case 4:
								System.out.println("4 - Saldo");
								System.out.println("Seu saldo disponível é de " + Saldo[2]);
								break;
							default:
						}
			}
