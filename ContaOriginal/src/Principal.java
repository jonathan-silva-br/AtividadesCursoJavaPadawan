		...
		while (op != 5) {
			if (clienteLogado == null) {
				 ...
				 case 2:
					 ...
					 System.out.print("Informe o valor para depósito na conta do " + clienteLogado.getNome() + " : R$");
				 ...
				 case 4:
					 ...
					 break;
				 case 6:
					 System.out.println("Extrato Bancário do Cliente " + clienteLogado.getNome());
					 System.out.println("Extrato Bancário do Cliente " + clienteLogado.getConta().getExtrato());
					 break;
				 default:
					 System.out.println("Opção Inválida");
				 } 
