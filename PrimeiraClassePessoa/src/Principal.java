...
public class Principal {
	...
	public static void main(String[] args) {
		...
		System.out.println("3 - Listar Aluno/Media/Situação");
		System.out.println("Opção: (NEGATIVO PARA ENCERRAR)");
		...
		while (opcao >= 0) {
			...
			case 3:
				for (int x = 0; x <= 4; x++) {
					...
					System.out.print(" ** Média: " + aluno[x].matricula.getMedia());
					System.out.println(" ** Situação: " + aluno[x].matricula.getSituacao());
				}
				break;
			default:
